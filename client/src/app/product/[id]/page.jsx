...
async function product({ params }) {
  ...
  return (
    <section className="flex flex-col md:flex-row justify-center items-center flex-wrap gap-10 mt-8">
          <div    
          className="w-[300px] md:w-[500px] flex flex-col md:flex-row justify-center items-center gap-8  p-4 
